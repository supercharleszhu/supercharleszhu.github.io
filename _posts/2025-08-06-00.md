...
torch._dynamo.reset() # cleanup the compiler cache
...
**What you'll see (under `torch_compile_debug/run_xxx/torchinductor`):**
...
Note: when generating the joint graph, internally it is calling `aot_dispatch_autograd_graph`
