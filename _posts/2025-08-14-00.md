...
tags: [pytorch, cuda, cutlass, optimization, deep-learning, kernel]
author: Charles Zhu
toc: true
math: true
...
These values (including `kNWarps` — see [GPU Architecture](#gpu-architecture-sms-warps-and-memory-hierarchy)) are set at the launch site via `Flash_fwd_kernel_traits<kHeadDim, kBlockM, kBlockN, kNWarps>`, and different GPU architectures get different configurations based on profiling.
