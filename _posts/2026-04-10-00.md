...
The bandwidth and latency tables are computed during initialization from the detected topology (NVLink BW, PCIe BW, etc). For small messages, latency dominates → LL protocol wins. For large messages, bandwidth dominates → Simple protocol wins.
