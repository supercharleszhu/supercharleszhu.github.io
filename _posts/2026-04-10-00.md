...
This is a critical distinction. It depends on which **protocol** NCCL selects:

**LL (Low Latency) Protocol** — used for smaller messages (our benchmark uses this: `AllReduce_Sum_f32_RING_LL`):
