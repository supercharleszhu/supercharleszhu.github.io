...
categories: [Machine Learning Performance, Kernel]
...
> 🧩 **Try it yourself** — I packaged every concept in this post as a 9-day puzzle repo: [**github.com/supercharleszhu/cutlass-puzzle**](https://github.com/supercharleszhu/cutlass-puzzle). Each day is a buildable `.cu` with critical lines replaced by `// TODO:` and a reference `solution.cu` next to it. Clone it, fill in the blanks, and you'll actually *write* CuTe code — not just read about it.
{: .prompt-tip }
...
↪ [`blog/01_tiled_copy.cu#L162`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/01_tiled_copy.cu#L162)

> ⚠️ **`make_tensor` does not copy data.** It's a zero-cost *view* — a lightweight wrapper around the existing pointer plus the layout metadata. No allocation happens, no bytes move, and the resulting `Tensor` aliases `d_S`. Mutating `tensor_S(i, j)` mutates the original buffer. Think of it as `std::span`, not `std::vector`. The same is true for `make_gmem_ptr` / `make_smem_ptr` / `make_rmem_ptr` — they just tag a pointer with a memory-space type so the compiler picks the right load/store instructions later.
{: .prompt-warning }
...
↪ [`blog/01_tiled_copy.cu#L171`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/01_tiled_copy.cu#L171)
...
↪ [`blog/01_tiled_copy.cu#L196`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/01_tiled_copy.cu#L196)
...
↪ [`blog/01_tiled_copy.cu#L107-L119`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/01_tiled_copy.cu#L107-L119)
...
- `…+260` — base pointer pre-offset for thread 65 at `(m=1, n=2)` with `val_M=4`, giving `1*4 + 2*128 = 260`.
- `(_4, _1, _8)` — shape: 4-float vector, 1 M-step, 8 N-steps.
- `(_1, _0, _1024)` — strides: contiguous within the vector, no M-repeats (mode is size-1), next N-slab is 1024 floats = 8 columns × 128 rows away.
...
↪ [`blog/02_sgemm_sm80.cu#L143-L150`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/02_sgemm_sm80.cu#L143-L150)
...
↪ [`blog/02_sgemm_sm80.cu#L261-L301`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/02_sgemm_sm80.cu#L261-L301)
...
↪ [`blog/02_sgemm_sm80.cu#L358-L363`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/02_sgemm_sm80.cu#L358-L363)
...
↪ [`blog/02_sgemm_sm80.cu#L383-L389`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/02_sgemm_sm80.cu#L383-L389)
...
↪ [`blog/02_sgemm_sm80.cu#L375-L377`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/02_sgemm_sm80.cu#L375-L377)
...
↪ [`blog/03_wgmma_sm90.cu#L332`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/03_wgmma_sm90.cu#L332)
...
↪ [`blog/03_wgmma_sm90.cu#L163-L164`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/03_wgmma_sm90.cu#L163-L164)
...
↪ [`blog/03_wgmma_sm90.cu#L267-L274`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/03_wgmma_sm90.cu#L267-L274)
...
↪ [`blog/04_wgmma_tma_sm90.cu#L301-L306`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/04_wgmma_tma_sm90.cu#L301-L306)
...
↪ [`blog/04_wgmma_tma_sm90.cu#L174-L179`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/04_wgmma_tma_sm90.cu#L174-L179)
...
↪ [`blog/04_wgmma_tma_sm90.cu#L217-L218`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/04_wgmma_tma_sm90.cu#L217-L218)
...
↪ [`blog/05_blackwell_mma_sm100.cu#L229-L241`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/05_blackwell_mma_sm100.cu#L229-L241)
...
↪ [`blog/05_blackwell_mma_sm100.cu#L286-L297`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/05_blackwell_mma_sm100.cu#L286-L297)
...
↪ [`blog/05_blackwell_mma_sm100.cu#L303-L321`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/05_blackwell_mma_sm100.cu#L303-L321)
...
↪ [`blog/06_blackwell_mma_tma_sm100.cu#L491-L496`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/06_blackwell_mma_tma_sm100.cu#L491-L496)
...
↪ [`blog/06_blackwell_mma_tma_sm100.cu#L309-L313`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/06_blackwell_mma_tma_sm100.cu#L309-L313)
...
↪ [`blog/07_blackwell_mma_tma_multicast_sm100.cu#L528-L534`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/07_blackwell_mma_tma_multicast_sm100.cu#L528-L534)
...
↪ [`blog/07_blackwell_mma_tma_multicast_sm100.cu`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/07_blackwell_mma_tma_multicast_sm100.cu)
...
↪ [`blog/08_blackwell_mma_tma_2sm_sm100.cu#L450-L452`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/08_blackwell_mma_tma_2sm_sm100.cu#L450-L452)
...
↪ [`blog/08_blackwell_mma_tma_2sm_sm100.cu#L531-L537`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/08_blackwell_mma_tma_2sm_sm100.cu#L531-L537)
...
↪ [`blog/08_blackwell_mma_tma_2sm_sm100.cu`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/08_blackwell_mma_tma_2sm_sm100.cu)
...
↪ [`blog/09_blackwell_mma_tma_epi_sm100.cu#L132-L139`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/09_blackwell_mma_tma_epi_sm100.cu#L132-L139)
...
↪ [`blog/09_blackwell_mma_tma_epi_sm100.cu#L423-L455`](https://github.com/supercharleszhu/cutlass-puzzle/blob/d9f28485370055203cc2f9fb78df3d61e59f1020/blog/09_blackwell_mma_tma_epi_sm100.cu#L423-L455)
...
**[github.com/supercharleszhu/cutlass-puzzle](https://github.com/supercharleszhu/cutlass-puzzle)**
