...
This is unbiased but high-variance — it can even go negative on individual samples. John Schulman's [KL approximation note](http://joschu.net/blog/kl-approx.html) introduced a low-variance unbiased alternative (the "K3" estimator):
...
- **Schulman's KL approximation note** ([joschu.net](http://joschu.net/blog/kl-approx.html)) — why K3 is the right estimator. Two pages.
